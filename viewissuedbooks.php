...
<body>
      ...
      <div class=" card-body">
        <table class="table" id="myTable">
          ...
          <tbody>
            ...
            $qresult = mysqli_query($conn, 'select * from issued_details');
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Update Book Return Date</h5>
          ...
          <form action="" method="POST">
            <div class="modal-body">
              <div class="m-2">
                ...
                <label for="returndate" class="form-label">Enter Return Date</label>
                <input type="date" name="returndate" class="form-control" id="returndate" placeholder="Return Date here..." />
              </div>
            </div>
  ...
  <script>
    ...
    function solve(e) {
      console.log(e.parentElement.parentElement.childNodes[0].innerText);
      var id = e.parentElement.parentElement.childNodes[0].innerText;
...
<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $query = "update issued_details set returndate='$returndate' where id='$id'";
        mysqli_query($conn, $query);
        echo "<script>
            alert('Updated Return Date');
            window.location.href = 'viewissuedbooks.php';
            </script>";
    }
?>